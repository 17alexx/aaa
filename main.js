...
// const olke = users.filter(users => users.address.country == "United States");
// console.log(olke);
...
// function createMapFromArray(usersArray) {
//     try {
...
// const userMap = createMapFromArray(users);
...
// function deleteUserById(usersArray, id) {
//     const userMap = new Map(usersArray.map(user => [user.id, user]));
//     userMap.delete(id);
//     return userMap; 
// }
// let updatedMap = deleteUserById(users, 2); 
